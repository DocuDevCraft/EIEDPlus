...
@section('title-page')
    <span class="icon"><img src="{{ asset('/modules/supportsystem/images/icons/support.gif') }}"></span>
                        ...
                        <div class="widget-content widget-content-padding widget-content-padding-side">
                            ...
                            <div class="form-group row no-gutters">
                                ...
                                <select data-placeholder="یک مورد را انتخاب کنید..." class="select chosen-rtl" name="priority" id="priority">
                                    ...
                                    'priority', $Support->priority)== 'high')>زیاد
                                    </option>
                                    <option value="medium" @selected(old(
                                    'priority', $Support->priority)== 'medium')>متوسط
                                    </option>
                                    <option value="low" @selected(old(
                                    'priority', $Support->priority)== 'low')>کم
                                    </option>
                                </select>
                            ...
                            <div class="form-group row no-gutters">
                                ...
                                <select data-placeholder="یک مورد را انتخاب کنید..." class="select chosen-rtl" name="status" id="status">
                                    ...
                                    'status', $Support->status) == 'replied')>پاسخ داد
                                    </option>
                                    <option value="closed" @selected(old(
                                    'status', $Support->status) == 'closed')>بسته شد
                                    </option>
                                    <option value="pending" @selected(old(
                                    'status', $Support->status) == 'pending')>در انتظار پاسخ
                                    </option>
                                </select>
