...
class WorkPackageRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'offer_time' => 'required',
            'attachment_for_all' => 'nullable|file|max:10240|mimes:jpg,jpeg,png,webp,pdf,doc,docx',
            'attachment_for_winner' => 'nullable|file|max:10240|mimes:jpg,jpeg,png,webp,pdf,doc,docx',
        ];
    }
    ...
    public function attributes()
    {
        return [
            ...
            'attachment_for_all' => 'مستندات',
            'attachment_for_winner' => 'مستندات برنده'
        ];
    }
