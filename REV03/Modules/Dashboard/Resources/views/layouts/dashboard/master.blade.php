...
<head>
    ...
    <title>@hasSection('title')
            @yield('title') -
        @endif پنل مدیریت</title>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('/modules/dashboard/admin/img/base/favicon.png') }}">

    {{-- Notifier --}}
    <link href="{{ asset('/modules/dashboard/admin/css/notifi/style.css') }}" rel="stylesheet" type="text/css">

    {{-- Library Storage --}}
    <link href="{{ asset('/modules/dashboard/admin/plugins/chosen.jquery/css/chosen.min.css') }}" rel="stylesheet" type="text/css">

    {{-- Web Admin --}}
    <link href="{{ asset('/modules/dashboard/admin/css/admin-style.min.css') }}" rel="stylesheet" type="text/css">
    ...
    <div class="row no-gutters">
        <aside class="col-2 sidebar-col">
            <div class="sidebar">
                ...
                <span class="version">DerisTech CMS - v{{ env('APP_VERSION') }}</span> <span class="update">Last Update: {{ env('APP_LAST_VERSION') }}</span>
            </div>
        </aside>

        <article class="col-10 content-page">
            <div class="heading-content-section">
                <div class="heading-inner">
                    <div class="row align-items-center">
                        ...
                        <div class="col-3 left head-btn-col">
...
{{-- Library --}}
<script src="{{ asset('/modules/dashboard/admin/js/jquery.min.js') }}"></script>
<script src="{{ asset('/modules/dashboard/admin/js/bootstrap.min.js') }}"></script>

{{-- Notify --}}
<script src="{{ asset('/modules/dashboard/admin/css/notifi/index.var.js') }}"></script>

{{-- Chosen --}}
<script src="{{ asset('/modules/dashboard/admin/plugins/chosen.jquery/js/chosen.jquery.min.js') }}"></script>

{{-- APP JS --}}
<script src="{{ asset('/modules/dashboard/admin/js/admin.js') }}"></script>
<script src="{{ asset('/modules/dashboard/admin/js/footer.js') }}"></script>
