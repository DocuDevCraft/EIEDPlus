...
@section('title-page')
    <span class="icon"><img src="{{ asset('/modules/dashboard/admin/img/base/icons/dashboard.gif ') }}"></span>
    <span class="text">میزکار</span>
@endsection

@section('lib')
    {{--    <script src="{{ asset('/modules/dashboard/admin/js/masonry.pkgd.min.js ') }}"></script>--}}
@endsection
