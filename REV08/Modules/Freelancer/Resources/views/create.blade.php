                ...
                <div class="col-9">
                    ...
                    <div class="widget-block widget-item widget-style">
                        <div class="heading-widget">
                            <div class="row">
                                <div class="col-9">
                                    <span class="widget-title">تنظیمات امنیتی</span>
                                </div>
                                <div class="col-3 left"></div>
                            </div>
                        </div>
                        ...
                        <div class="widget-content widget-content-padding">
                            <div class="form-group row no-gutters">
                                ...
                                @endif
                                <input type="password" name="password" class="col-12 field-style input-text" id="password" autocomplete="new-password" placeholder="رمز عبور کاربر را وارد نمایید">
                            ...
                            <div class="form-group row no-gutters">
                                ...
                                <div class="col-12 field-style ">
                                    <select data-placeholder="یک مورد را انتخاب کنید" id="role" class="select chosen-rtl" name="role">
                                        ...
                                        <option value="user" @selected(old("role") == "user")>کاربر</option>
                                    </select>
                                </div>
...
@section('footer')
    ...
    @if(old("city"))
        <script>CityList({{ old("city") }});</script>
    @endif

    @if(old("city"))
        <script>
            $("#city option[value='{{ old("city") }}']").attr("selected", "selected");
            $(".select").trigger("chosen:updated");
        </script>
    @endif
